...
app.get('/team_stats', function (req, res) {
	var query1 = 'select * from football_games;'; // get all games
	var query2 = 'select count(*) from football_games where home_score > visitor_score;'; // get winning games
	var query3 = 'select count(*) from football_games where home_score < visitor_score;'; // get losing games
	db.task('get-everything', task => {
		return task.batch([
			task.any(query1),
			task.any(query2),
